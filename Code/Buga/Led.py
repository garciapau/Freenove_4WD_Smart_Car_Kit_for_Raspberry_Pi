...
class Led:
    ...
    def turnLightsOff(self):
        self.colorWipe(led.strip, Color(0, 0, 0))  # turn off the light

    def frontLights(self):
        self.ledIndex(0x20, 0, 255, 0)
        self.ledIndex(0x40, 0, 255, 0)

    def backLights(self):
        self.turnLightsOff()
        self.ledIndex(0x02, 0, 255, 0)
        self.ledIndex(0x04, 0, 255, 0)

    def frontLightsBlue(self):
        self.turnLightsOff()
        self.ledIndex(0x20, 0, 0, 255)
        self.ledIndex(0x40, 0, 0, 255)

    def frontLeftLight(self):
        self.turnLightsOff()
        self.ledIndex(0x20, 255, 0, 0)

    def frontRightLight(self):
        self.turnLightsOff()
        self.ledIndex(0x40, 255, 0, 0)
